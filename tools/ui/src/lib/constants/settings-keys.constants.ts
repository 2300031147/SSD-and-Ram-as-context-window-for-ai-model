...
export const SETTINGS_KEYS = {
	...
	// Tiered Storage & Secondary SSD Cache
	KV_SWAP_ENABLED: 'kvSwapEnabled',
	KV_SWAP_PATH: 'kvSwapPath',
	KV_SWAP_DRIVE: 'kvSwapDrive',
	KV_SWAP_RAM_SIZE_GB: 'kvSwapRamSizeGB',
	KV_SWAP_SIZE_GB: 'kvSwapSizeGB',
	KV_SWAP_BLOCK_SIZE: 'kvSwapBlockSize',
	KV_SWAP_ENGINE: 'kvSwapEngine',
	TURBOQUANT_K: 'turboquantK',
	TURBOQUANT_V: 'turboquantV',
