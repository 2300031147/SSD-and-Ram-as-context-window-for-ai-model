...
enum server_task_type {
    ...
    SERVER_TASK_TYPE_CONFIG_KV_SWAP,
};
...
struct server_task {
    ...
    // used by SERVER_TASK_TYPE_CONFIG_KV_SWAP
    struct kv_swap_config {
        bool enabled;
        std::string drive;
...
struct server_task_result_config_kv_swap : server_task_result {
    bool enabled;
    std::string drive;
    std::string resolved_path;
    double size_gb;
