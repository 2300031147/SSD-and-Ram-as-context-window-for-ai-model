...
int llama_server(common_params & params, int argc, char ** argv) {
    ...
    ctx_http.get ("/drives",                   ex_wrapper(routes.get_drives));
    ctx_http.get ("/v1/drives",                ex_wrapper(routes.get_drives));
    ctx_http.post("/kv-swap/config",           ex_wrapper(routes.post_kv_swap_config));
    ctx_http.post("/v1/kv-swap/config",        ex_wrapper(routes.post_kv_swap_config));
